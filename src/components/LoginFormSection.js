    ...
    return(
        ...
        <div class="ui two column centered grid">
            ...
            <div class="four wide column">
                <button className="ui yellow fluid button" onClick={() => props.handleFormSwitch("signUp")}>Sign Up</button>
                {/* <Link to='/signup'> <button className="ui yellow large button">New User</button></Link>   */}
            </div>
            <div class="four wide column">
                <button className="ui yellow fluid button" onClick={() => props.handleFormSwitch("login")}>Log In</button>
